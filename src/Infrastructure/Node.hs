...
( Node(Node)
, HasNode(type ChildType, make, getName, addTo, addChild, removeChild, getChildren, getChild, toNode, fromNode)
, wrap
, getConfigPairs
, getConfig
, setConfig
