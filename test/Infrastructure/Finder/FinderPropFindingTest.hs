...
presentOnFind rt n [roo]                 = let z = (zero,n)                   in getName n == roo && [z] == find zero rt                                                                                       && Just z == findUnambiguous zero rt                    
presentOnFind rt n [roo,r]               = let z = (one roo,n)                in getName n == r   && [z] == find (oneM r) rt                 && all (z `elem`) (map (`find`rt) $ partialOne r)                 && Just z == findUnambiguous (oneM r) rt                
presentOnFind rt n [roo,r,t]             = let z = (two roo r,n)              in getName n == t   && [z] == find (twoM r t) rt               && all (z `elem`) (map (`find`rt) $ partialTwo r t)               && Just z == findUnambiguous (twoM r t) rt              
presentOnFind rt n [roo,r,t,c]           = let z = (three roo r t,n)          in getName n == c   && [z] == find (threeM r t c) rt           && all (z `elem`) (map (`find`rt) $ partialThree r t c)           && Just z == findUnambiguous (threeM r t c) rt          
presentOnFind rt n [roo,r,t,c,g]         = let z = (four roo r t c,n)         in getName n == g   && [z] == find (fourM r t c g) rt          && all (z `elem`) (map (`find`rt) $ partialFour r t c g)          && Just z == findUnambiguous (fourM r t c g) rt         
presentOnFind rt n [roo,r,t,c,g,p]       = let z = (five roo r t c g,n)       in getName n == p   && [z] == find (fiveM r t c g p) rt        && all (z `elem`) (map (`find`rt) $ partialFive r t c g p)        && Just z == findUnambiguous (fiveM r t c g p) rt       
presentOnFind rt n [roo,r,t,c,g,p,pr]    = let z = (six roo r t c g p,n)      in getName n == pr  && [z] == find (sixM r t c g p pr) rt      && all (z `elem`) (map (`find`rt) $ partialSix r t c g p pr)      && Just z == findUnambiguous (sixM r t c g p pr) rt     
presentOnFind rt n [roo,r,t,c,g,p,pr,tr] = let z = (seven roo r t c g p pr,n) in getName n == tr  && [z] == find (sevenM r t c g p pr tr) rt && all (z `elem`) (map (`find`rt) $ partialSeven r t c g p pr tr) && Just z == findUnambiguous (sevenM r t c g p pr tr) rt
